...
@synthesize travelMode = _travelMode,locationManager;
...
{
     CGPoint point = [recognizer locationInView:self.theMapView];
     
     CLLocationCoordinate2D tapPoint = [self.theMapView convertPoint:point toCoordinateFromView:self.view];
    [theMapView removeAnnotation:point1];
    
     
     point1.coordinate = tapPoint;
     CLLocation *coord = [[CLLocation alloc] initWithLatitude:point1.coordinate.latitude longitude:point1.coordinate.longitude];
     [self.theMapView addAnnotation:point1];
    
     NSLog(@"%f %f",point1.coordinate.longitude,point1.coordinate.latitude);
     
     [self getAddressFromLatLon:coord];/**/
}
...
- (void) getAddressFromLatLon:(CLLocation *)bestLocation
{
    ...
    [geocoder reverseGeocodeLocation:bestLocation
                   completionHandler:^(NSArray *placemarks, NSError *error)
     {
         ...
         UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Adres"
                                                         message:Address
                                                        delegate:self
...
- (void)viewDidLoad
{
    ...
    [self.theMapView addGestureRecognizer:tapRecognizer];
