...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        [inputField setText:[NSString stringWithUTF8String:"ankara"]];
        inputField.tag=5000;
        ...
        [inputField setText:[NSString stringWithUTF8String:"istanbul"]];
        inputField.tag=5001;
        endField = inputField;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 2 && indexPath.row == 0) {
        MapControllerViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"MapControllerViewController"];
        ...
        [self showViewController:controller sender:0];
